                                            ...
                                            <td style="text-align:center;">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td>
                                                            {{--<img alt="微信扫码" src="/images/wxpay_code_foot3.jpg" />--}}
                                                        </td>
                                                    </tr>
                                                    {{--<tr>--}}
                                                    {{--<td></td>--}}
                                                    {{--<td><img alt="微信扫码" src="/images/wxpay_code_foot.jpg" /></td>--}}
                                                    {{--</tr>--}}
                                                    </tbody>
                                                </table> </td>
                                            <td><img alt="微信扫码" src="/images/wxpay_code_ad.jpg" /></td>
                                            <td width="20%"> </td>
                                        </tr>
                                        </tbody>
                                    </table>
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data.success == 'true'){
                    $(window).attr('location','/capital/alipayreturn');
                }
            }
        });
    }
