                                ...
                                <div class="m-login-container" style="">
                                    ...
                                    <div class="m-login-form" >
                                        <form id="login-form" class="form-horizontal" method="POST" action="" autocomplete="off" onsubmit="return false;">
                                            ...
                                            <h2 class="title" style="color: #ea4335;font-weight: 1000">OMS管理平台</h2>
                                            <p style="text-align: center;font-size: 16px">ORDER MANAGEMENT SYSTEM</p>
                                            ...
                                            <div class="m-form-group">
                                                <div class="m-input-group">
                                                    <img src="../images/erp/phone.png" class="img_icon"/>
                                                    <input type="text" name="phone" class="m-input m-input-large account-input"  autocomplete="off"  placeholder="请输入预留手机号" >
                                                </div>
                                            </div>
    ...
    $(".m-btn-submit").click(function (e) {
        ...
        if(mobile == ''){
            ...
            //var $phone = $("#mobile").val();
                var phoneRegular = /^[1][3,4,5,7,8,9][0-9]{9}$/;
                if (!phoneRegular.test(mobile)) {
                    $('#esm').html('请填写正确手机号');
                    setTimeout(function () {
                        $('#esm').html('') ;
                    }, 2000);
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                if(data.code==1){
                   /* /!*  window.localStorage.setItem('s', 656);
                      window.localStorage.getItem('s');
                      console.log(window.localStorage.getItem('s'));*/
                    // 请求发送手机验证码
                    $.ajax({
                        url:"/login/sendsms",
                        type: "POST",
                        ...
                        success: function (data) {
                            $(window).attr('location','/login/validatelogin');
                        }
                    });
