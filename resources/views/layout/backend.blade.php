...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/adminlte/theme_backend.css') }}">
...
<div class="wrapper">
    @include('common.header',['systemName'=>'cms'])

    @include('common.slidebar',['system'=>'CMS', 'systemName'=>'cms'])
