...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/adminlte/theme_erp.css') }}">
...
<div class="wrapper">
    @include('common.header',['is_erp'=>true])

    @include('common.slidebar',['system'=>'OMS', 'systemName'=>'erp'])
