...
@section("main-content")
    ...
    <div id="main">
        ...
        <div class="" style="margin-top:20px">
            @include('erpkf.auth.group._search')
        </div>
        <!--  提示功能 end -->
        ...
        <div id="act-btn" style="padding:20px 0">
            ...
            <button data-area="['70%', '700px']" data-url="{{URL::asset('/auth/group/form')}}" data-title = "添加" class="btn-dialog btn btn-primary btn-sm btn-3F51B5 btn-add">
