<div class="good-info-fill" style="display: none">
    ...
    <div class="form-group row form-item">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                ...
                <span class="col-sm-5 control-label pi-cate-name" style="text-align: left!important;"> 印刷产品>个性印刷>摆台/插画/框画</span>
    ...
    <div class="form-group row form-item">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                <input  id="prod_name" class="form-control col-sm-5" name="prod_name" type="text" value="" placeholder="请填写商品名称" {{--data-rule="商品名称:required"--}}>
    ...
    <div class="form-group row form-item">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                <input  id="prod_abbr" class="form-control col-sm-5" name="prod_abbr" type="text" value="" placeholder="请填写商品简称" {{--data-rule="商品名称:required"--}}>
    ...
    <div class="form-group row form-item">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                <textarea class="form-control col-sm-5" name="prod_title" id="" cols="30" rows="5" style="resize: none;"></textarea>
    ...
    <div class="form-group row form-item">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                ...
                <label for="cus_prod_cate_uid"></label>
                <select  class="selectpicker form-control col-sm-5 cus_prod_cate_uid bla bla bli" title="无" multiple data-live-search="false"  id="cus_prod_cate_uid" name="cus_prod_cate_uid" >
                    @foreach ($customCategoryList as $k=>$v)
                        <option value='{{$v['cus_cate_id']}}'>{{$v['cate_name']}}</option>
                    @endforeach
    ...
    <div class="form-group row form-item">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                <input  id="prod_sn" class="form-control col-sm-5" name="prod_sn" type="text" value="" placeholder="">
    ...
    <div class="form-group row form-item">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                <input  id="prod_fee" class="form-control col-sm-5" name="prod_fee" type="number" value="" placeholder="" >
                <span class="col-sm-7 color-6A6969"> </span>
            </div>
    ...
    <div class="form-group row form-item">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                <input  id="prod_sn" class="form-control col-sm-5" name="prod_unit" type="text" value="" placeholder="">
                <span class="col-sm-7 color-6A6969"> </span>
            </div>
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                <div class="col-sm-1" style="line-height: 30px;">
                    ...
                    @component('component/checkbox',['checkbox'=>[1=>'启用库存'],'name'=>['prod_stock_status'],'custom_class'=>'','right_distance' => '0'])
                    @endcomponent
                </div>

                <input  id="prod_sn" class="form-control col-sm-4 stock-control" name="prod_stock_inventory" type="text" value="" placeholder="" style="display: none">
                <span class="stock-control-line col-sm-4" ></span>
    ...
    <div class="form-group row form-item stock-control" style="display: none">
        <label style=" font-weight: normal" for="prod_stock_waring" class="control-label col-xs-12 col-sm-2 pgc-font">
            库存预警值：</label>
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                <input  id="prod_sn" class="form-control col-sm-5" name="prod_stock_waring" type="text" value="" placeholder="">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                <div style="padding-left: 0;min-height: 108px" class="col-sm-5">
                    @component('component/image_upload',['name'=>'prod_photos','uploader'=>'uploader1','num'=>5,'value'=>'','direction'=>1,'browse_btn'=>'form-avatar','content_class'=>'background','img_format'=>'jpg,jpeg,png',{{--'rule'=>'相册:required'--}}])
                    @endcomponent
                </div>
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                <div class="col-sm-2" style="line-height: 30px;">
                    ...
                    @component('component/radio',['radio'=>['1'=>'按固定运费'],'default_key'=>1,'name'=>'prod_express_type'])
                    @endcomponent
                </div>

                <input  id="prod_express_fee" class="form-control col-sm-3" name="prod_express_fee" type="number" value="" placeholder="">
                <span class="col-sm-7 color-6A6969 express_type_span">按固定运费表示每订单收取输入运费金额，如为包邮可设置为0元 </span>
            </div>
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                <div class="col-sm-2" style="line-height: 30px;">
                    ...
                    @component('component/radio',['radio'=>['2'=>'按运费模板'],'default_key'=>1,'name'=>'prod_express_type'])
                    @endcomponent
                </div>
                <select  class="form-control col-sm-3" id="prod_express_tpl_id" name="prod_express_tpl_id" class="form-control" style="display: none">
                    <option value="">无</option>

                    @foreach ($deliveryList as $k=>$v)
                        <option value='{{$v['del_temp_id']}}'>{{$v['del_temp_name']}}</option>
                    @endforeach
    ...
    <script id="pc_container" name="prod_details_pc" type="text/plain" style="width:100%;height:500px;"></script>
    <script id="mob_container" name="prod_details_mobile" type="text/plain" style="width:100%;height:500px;display:none"></script>
    ...
    <div class="form-group row form-item">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row" style="line-height: 30px">
                @component('component/radio',['radio'=>['1'=>'立即上架','0'=>'立即下架'],'default_key'=>'0','name'=>'prod_onsale_status'])
                @endcomponent
            </div>
    ...
    <div class="form-group row form-item">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                ...
                <input type="hidden" class="last_price_type" value="">
                <input type="hidden" class="now_price_type" value="2">
                <div class="col-sm-5" style="padding-right: 0;padding-left: 0;line-height: 30px">
                    @component('component/radio',['radio'=>['1'=>'SPU定价标准化商品（Standard Product Unit）','2'=>'SKU商品属性（Stock Keeping Unit）定价'],'default_key'=>'2','name'=>'prod_price_type'])
                    @endcomponent
                </div>
...
{{--    <div class="form-group row form-item">
    ...
    <div class="form-group row form-item">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                ...
                <div class="col-sm-5" style="padding-right: 0;padding-left: 0;line-height: 30px">
                    @component('component/radio',['radio'=>['1'=>'是','0'=>'否'],'default_key'=>'1','name'=>'prod_onsale_issingle'])
                    @endcomponent
                </div>
            ...
            <div class="row">
                ...
                @foreach($chanelList as $k=>$v)
                    ...
                    <div class="col-sm-5 row" style="line-height: 30px">
                        <div class="col-sm-4">
                            @component('component/checkbox',['checkbox'=>[$v['cha_id']=>$v['cha_name']],'name'=>['sales_chanel[]'],'data_value'=>$v['cha_flag'] ,'custom_class'=>'','right_distance' => '0'])
                            @endcomponent
                        </div>

                        <div class="gpd-group col-sm-8" style="display: none;padding-left: 0 !important;">
                            <div class="row">
                        @foreach($v['customerList'] as $kk=>$vv)
                                <div class="col-sm-3" style="white-space: nowrap;">
                            @component('component/checkbox',['checkbox'=>[$vv['cust_lv_id'] => $vv['cust_lv_name']],'name'=>['sales_chanel_customer['.$v['cha_id'].'][]'],'custom_class'=>'','right_distance' => '0'])
                            @endcomponent
                                </div>
                        @endforeach
                            </div>
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                ...
                @foreach($supplierList as $k=>$v)
                    ...
                    <div class="col-sm-5 " style="line-height: 30px">
                        @component('component/checkbox',['checkbox'=>[$v['sup_id']=>$v['supplier_new_name']],'name'=>['supplier[]'],'custom_class'=>'','right_distance' => '30'])
                        @endcomponent
                        {{-- <div class="gpd-group">
                             @component('component/checkbox',['checkbox'=>['银牌组','铜牌组','金牌组'],'name'=>['1','2','3'],'custom_class'=>'','right_distance' => '30'])
                             @endcomponent
    ...
    <div class="form-group row form-item" style="margin-bottom: 50px">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="col-sm-5" style="line-height: 30px">
                @component('component/checkbox',['checkbox'=>['1' => '按订单收货人地址自动匹配最近供应商'],'name'=>['prod_dist_rule'],'checked' => 1,'custom_class'=>'','right_distance' => '30'])
                @endcomponent
            </div>
        </div>
    </div>
    ...
    <div class="pgc-footer">
        <button class="btn btn-blue btn-go-good-cate" style="vertical-align: top;background: #ffffff;color: #000000;border: 1px solid #007bff">上一步,选择商品分类</button>
        <button class="btn btn-blue btn-go-good-attr" style="color: #ffffff;vertical-align: top;">下一步,填写商品属性</button>
    </div>
