...
@endsection
    ...
    <!--  提示组件 end -->
        ...
        <div class="cate-main">
            <form class="form-horizontal common-form" id="form-save" method="post" action="/goods/products/update" onsubmit="return false;" autocomplete="off">
...
@section("js-file")
   ...
   <script src="{{ URL::asset('js/merchant/goods/edit.js')}}?v={{config('common.js_version')}}"></script>
