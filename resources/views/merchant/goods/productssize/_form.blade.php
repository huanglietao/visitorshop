...
<div style="margin-top:30px">
    ...
    <input type=hidden value="{{$row['size_id']}}" name="id" id="id">
        ...
        <div class="form-group row form-item">
            <label style=" font-weight: normal" for="c-size_type" class="control-label col-xs-12 col-sm-2">
                <span style="color:red">*</span> 规格标签：</label>
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    <select   class="form-control col-sm-5"  style="display: inline-block; margin-right: 1%; " id="size_type" name="size_type" class="form-control" data-rule="所属规格标签:required" data-msg="请先选择所属规格标签">
        ...
        <div class="form-group row form-item">
            ...
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    <input  id="size_dpi" class="form-control col-sm-5" name="size_dpi" type="text" value="{{$row['size_dpi']}}" placeholder="" data-rule="规格名称:required">
