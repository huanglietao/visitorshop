    ...
    @slot('slot_main')
        <div class="search-item row" style="" >
                <div class="col-lg-4 form-group">
                    @component('component/search/label_input',['label'=>'规格名称', 'inp_name' => 'size_name', 'inp_id' => 'size_name'])
                    @endcomponent
                </div>
                ...
                <div class="col-lg-4 form-group">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-xl-8 col-md-8">
                            <select name="size_cate_id" style="padding:4px 8px;color:rgb(106, 105, 105);font-size:12px;" class="form-control">
