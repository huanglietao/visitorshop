...
<div class="Checkes" style="margin-top:20px;">
    <form class="form-horizontal" id="form-save" method="post" action="/order/distribution/{{$data[0]['ord_id']}}" autocomplete="off">
        @csrf
    ...
    <div class="form-group layer-footer">
        ...
        <div class="col-xs-12 col-sm-8">
            <button type="submit" class="btn btn-primary btn-3F51B5 btn-sure btn-submit">配货</button>
            &nbsp;&nbsp;&nbsp;&nbsp;
        </div>
    </div>
