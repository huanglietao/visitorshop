            ...
            <div class="d_o_info_item row" >
                ...
                <div class="col-lg-3 form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-9 d_o_info_item_val">
                            {{$data['delivery_name']}}
                            @if($data['order_shipping_status'] != ORDER_SHIPPED && $data['order_status'] != ORDER_STATUS_CANCEL)
                ...
                <div class="col-lg-3 form-group">
                    <div class="row">
                        <div class="col-lg-4 col-md-3 d_o_info_item_z">
                            <label class="control-label d_o_info_item_attr">旺旺号:</label>
                        </div>
                        <div class="col-lg-8 col-md-9 d_o_info_item_val">
                            {{$data['wangwang']}}
                        </div>
                        ...
                        <div class="col-lg-8 col-md-9 d_o_info_item_val">
                            @if(!empty($data['delivery_code']))
                                ...
                                {{--@component('component/tips_modal')--}}
                                    {{--@slot('slot_ele')--}}
                                        {{--<span><a href="" class="o_logistic_info">跟踪物流信息</a></span>--}}
                                    {{--@endslot--}}
                                    {{--<p>{{$data['delivery_name']}}：{{$data['delivery_code']}}</p>--}}
                                    {{--<ul>--}}
                                        {{--<li>暂无物流信息</li>--}}
                                    {{--</ul>--}}
                                {{--@endcomponent--}}
                        ...
                        <td class="d_o_attr d_o_attr_other">
                            @if($v['prj_type'] != WORKS_FILE_TYPE_EMPTY)
                                <div class="double-d" onclick="showWork(this)">
                                    <img src="/images/mch-chevron-double-down.png" alt="" data-action = "show">
                                </div>
                            @endif
                        </td>
                    </tr>
        ...
        <div class="d_o_info_line">
            <div class="d_o_info_operate" >
                ...
                @if($data['order_status'] == ORDER_STATUS_FINISH || $data['order_status'] == ORDER_STATUS_WAIT_RECEIVE)
                    {{--订单发货后才可申请售后--}}
                    <button class="btn od_aftersale  btn-operat"><a href="{{URL::asset('/#/order/service')}}" style="color: #FF6A01;">订单售后</a></button>
                @endif
...
@section("pages-js")
    function showWork(obj) {
        ...
        if (action == "hide")
        {
            $(obj).find("img").attr("src","/images/mch-chevron-double-down.png");
            $(obj).find("img").attr("data-action","show");
            $(obj).parent().parent().parent().parent().parent().next().slideUp(500);
        }else{
            $(obj).find("img").attr("src","/images/mch-chevron-double-up.png")
