            ...
            <div class="col-lg-4 form-group">
                <div class="row" >
                    <div class="col-xl-4 col-md-4" style="text-align: right" >
                        <label class="control-label" style="font-weight: normal">分销商:</label>
                    </div>
                    <div class="col-xl-8 col-md-8" style="white-space: nowrap;margin-top: 3px;display: flex">
                        <select style="padding:4px 8px;color:rgb(106, 105, 105);font-size:12px;" class="form-control" name="user_id">
                            @foreach($agent as $k=>$v)
                                <option value="{{$k}}" @if($user_id==$k) selected @endif >{{$v}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="col-lg-4 form-group">
                <div class="row" >
                    ...
                    <div class="col-xl-8 col-md-8" style="white-space: nowrap;margin-top: 3px">
                        <select style="padding:4px 8px;color:rgb(106, 105, 105);font-size:12px;" class="form-control" name="cus_balance_type_detail">
