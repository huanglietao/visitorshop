        ...
        <div class="form-group row form-item">
            ...
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    ...
                    <span class="col-sm-5 color-6A6969" style="color: red">该广告在具体投放的位置（特殊的请选择专属布局）</span>
                </div>
        ...
        <div class="form-group row form-item" style="height: 12%;">
            ...
            <div class="col-xs-12 col-sm-10">
                <div class="row pos-general">
                    ...
                    <span class="col-sm-6 color-6A6969" style="color: red">专属布局选择单图且只能传单张，格式：gif / jpg / jpeg / png。</span>
                </div>
            </div>
        </div>
