...
@section("main-content")
    ...
    <div id="main">
        ...
        <div class="" style="margin-top:20px">
            @include('merchant.auth.group._search')
        </div>
        <!--  搜索功能 end -->
        ...
        <div id="act-btn" style="padding:20px 0">
            ...
            <button data-area="['70%', '85%']" data-url="{{URL::asset('/auth/group/form')}}" data-title = "添加" class="btn-dialog btn btn-primary btn-sm btn-3F51B5 btn-add">
        ...
        <!-- 列表start  -->
        <div id="table">
            <table class="no-border-table" data-url="/auth/group/list">
                <thead>
                <tr class="table-head">
                    <td>角色名称</td>
                    <td>创建时间</td>
