...
<div style="margin-top:30px">
    <form class="form-horizontal common-form" id="form-save" method="post" action="/auth/admin/save" onsubmit="return false;" autocomplete="off">
        <input type=hidden value="{{$row['oms_adm_id']}}" name="id" id="id">
        <input type=hidden value="{{$row['is_main']}}" name="is_main">
                ...
                <div class="row">
                    <select  class="form-control col-sm-7" id="oms_adm_group_id" name="oms_adm_group_id" class="form-control" data-rule="商户角色组:required">
                        @foreach($groupList as $k=>$v)
                            <option value={{$v['oms_group_id']}} @if($v['oms_group_id'] == $row['oms_adm_group_id']) selected @endif >{!! $v['oms_group_name'] !!}</option>
                        @endforeach
                    </select>
        ...
        {{--<div class="form-group row form-item">--}}
            ...
            {{--<div class="col-xs-12 col-sm-10">--}}
                {{--<div class="row">--}}
                    {{--<select  class="form-control col-sm-7" id="mch_id" name="mch_id" class="form-control"  data-rule="商户资料:required">--}}
                        {{--@foreach($infoList as $k=>$v)--}}
                            {{--<option value={{$v['mch_id']}} @if($v['mch_id'] == $row['mch_id']) selected @endif >{{$v['mch_name']}}</option>--}}
                        {{--@endforeach--}}
                    {{--</select>--}}
                    {{--<span class="col-sm-5 color-6A6969">绑定商户资料信息</span>--}}
                {{--</div>--}}
        ...
        <div class="form-group row form-item">
            ...
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    <input  id="oms_adm_username" class="form-control col-sm-7" name="oms_adm_username" type="text" value="{{$row['oms_adm_username']}}" placeholder="" data-rule="商户账号:required">
        ...
        <div class="form-group row form-item">
            ...
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    ...
                    <span class="col-sm-5 color-6A6969">商户登录使用密码@if ($row['oms_adm_id']) ,不修改密码请留空。  @endif</span>
                </div>
        ...
        <div class="form-group row form-item">
            ...
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    <input  id="oms_adm_nickname" class="form-control col-sm-7" name="oms_adm_nickname" type="text" value="{{$row['oms_adm_nickname']}}" placeholder="" >
            ...
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    <div style="padding-left: 0;height: 108px" class="col-sm-7">
                        @component('component/image_upload',['name'=>'oms_adm_avatar','direction'=>1,'browse_btn'=>'form-avatar','content_class'=>'background','img_format'=>'jpg,jpeg,png','uploader'=>'uploader','num'=>1,'value'=>$row['oms_adm_avatar']])
                        @endcomponent
                    </div>
        ...
        <div class="form-group row form-item">
            ...
            <div class="col-xs-12 col-sm-10" style="padding-top: 6px;">
                <div class="row">
                    @component('component/radio',['radio'=>[PUBLIC_ENABLE=>'启用',PUBLIC_DISABLE=>'禁用'],'name'=>'oms_adm_status','default_key'=>$row['oms_adm_status']??PUBLIC_ENABLE])
                    @endcomponent
                </div>
            </div>
        </div>
