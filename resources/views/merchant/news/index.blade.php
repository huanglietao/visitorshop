...
@section("main-content")
    ...
    <div id="main">
        ...
        <div style="height: 100%">
            ...
            <!--  列表 start -->
            <div id="table">
             {{--   @php var_dump($_SERVER['QUERY_STRING']);die; @endphp--}}
                 <table class="no-border-table" data-url="/news/list?{{$_SERVER['QUERY_STRING']}}">
                    <thead>
                    <tr class="table-head">
...
<!--  加载js -->
@section("js-file")
    <script src="{{ URL::asset('js/merchant/news.js')}}"></script>
@endsection
@section("pages-js")
