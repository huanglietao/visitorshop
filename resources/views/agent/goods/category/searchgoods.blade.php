...
@section("main-content")
    ...
    <!-- 面包屑 start  -->
    {{--@component('component/goods_crumb',['icon' => 'fa-dashboard', 'title' => '控制台 / 商品管理 / 商品分类33'])--}}
    ...
    <div id="main">
       ...
       {{-- @component('component/goods_list',['is_show' => 0])
            ...
            @foreach($products_list as $product_key =>$product_val)
                <a href="{{URL::asset('/goods/detail/index/'.$product_val['prod_id'])}}">
                    <div class="goods-twenty-seven category-four">
                        <div class="goods-twenty-eight">
                            <img class="goods-nine" @if($product_val['prod_main_thumb']) src="{{$product_val['prod_main_thumb']}}"@else src="/images/home/moren.jpg" @endif onerror="this.src='/images/home/moren.jpg'" />
                        </div>
                        <span class="goods-twenty-nine">{{$product_val['prod_name']}}</span>
                        <span class="goods-thirty-one">{{$product_val['prod_title']}}</span>
                        <span class="goods-thirty-two">￥{{$product_val['prod_fee']}}元</span>
                    </div>
                </a>
            @endforeach
        @endcomponent--}}
