...
<div style="margin-top:30px">
    <form class="form-horizontal common-form" id="form-save" method="post" action="/works/save" onsubmit="return false;" autocomplete="off">
        ...
        <div class="form-group row form-item">
            ...
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    <input  class="form-control col-sm-5" name="prj_outer_account" id="nickname" type="text" value="{{$project['prj_temp']['prj_outer_account']}}" placeholder="">
                </div>
        ...
        <div class="form-group row form-item">
            <label style=" font-weight: normal" for="c-mch_name" class="control-label col-xs-12 col-sm-2">作品数量：</label>
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    <input id="c-mch_name" class="form-control col-sm-5" name="ord_quantity" type="text" @if(!empty($project['prj_temp']['ord_quantity'])) value="{{$project['prj_temp']['ord_quantity']}}" @else value="1" @endif placeholder="">
                </div>
            </div>
        </div>
