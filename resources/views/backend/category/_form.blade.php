...
<div style="margin-top:30px">
    <form class="form-horizontal common-form" id="form-save" method="post" action="/category/save" onsubmit="return false;" autocomplete="off">
    <input type=hidden value="{{$row['cate_id']}}" name="id" id="id">
        @if($cateType=='goods')
        <input type=hidden value="{{$row['cate_parent_id']}}" name="cate_parent_id" >
        @endif
        <div class="form-group row form-item">
            ...
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    <select   class="form-control col-sm-5" @if($cateType=='goods') disabled @endif  style="display: inline-block; margin-right: 1%; " id="cate_parent_id" name="cate_parent_id" class="form-control" >
                        @if(empty($categoryList) || $cateType=='background')
                    ...
                    @if($cateType=='background')
                        <span class="col-sm-5 color-6A6969">背景分类只有一级分类，父级全部选择无</span>
                    @endif
                </div>
        ...
        <div class="form-group row form-item">
            <label style=" font-weight: normal" for="c-mch_name" class="control-label col-xs-12 col-sm-2">
            <span style="color:red">*</span> 分类别名：</label>
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    <input  id="cate_nickname" class="form-control col-sm-5" name="cate_nickname" type="text" value="{{$row['cate_nickname']}}" placeholder="" data-rule="分类别名:required">
        ...
        <div class="form-group row form-item">
            <label style=" font-weight: normal" for="c-mch_name" class="control-label col-xs-12 col-sm-2">
            <span style="color:red">*</span> 分类单位：</label>
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    <input  id="cate_unit" class="form-control col-sm-5" name="cate_unit" type="text" value="{{$row['cate_unit']}}" placeholder="" data-rule="分类单位:required">
        ...
        <div class="form-group row form-item">
            <label style=" font-weight: normal" for="c-mch_name" class="control-label col-xs-12 col-sm-2">
            <span style="color:red">*</span> 分类关键词：</label>
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    <input  id="cate_keywords" class="form-control col-sm-5" name="cate_keywords" type="text" value="{{$row['cate_keywords']}}" placeholder="" data-rule="分类关键词:required">
