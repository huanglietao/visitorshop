...
@section("main-content")
    <!-- 面包屑组件start  -->
    @component('component/crumb',['icon' => 'fa-dashboard', 'title' => '控制台 / 数据管理 / 交货率统计' ])
    @endcomponent
    <!-- 面包屑组件end  -->
<div id="main">
        <!--  提示组件 start -->
    ...
    <div class="" style="margin-top:20px">
        @include('backend.statistics.consignment._search',['InfoList'=>$InfoList])
    </div>
    <!--  查询 end -->
    ...
    <div id="act-btn" style="margin:20px 0 10px 0;display: flex;justify-content: space-between;">
        ...
        <button id="consign_export" class="btn btn-write btn-undo" style="margin-right: 0"><i class="fa fa-download"></i> 导出</button>
    </div>
    <!--  操作按钮 end -->

    <!-- 列表start  -->
    <div id="table">
        <table class="no-border-table" data-url="/statistics/consignment/list">
            <thead>
            <tr class="table-head">
