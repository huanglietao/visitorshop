...
@slot('slot_main')
    <div class="search-item row" style="" >
        <div class="col-lg-4 form-group .first_o_group">
            @component('component/search/label_input',['label'=>'商品货号','inp_name'=>'prod_sku_sn'])
            @endcomponent
        </div>
            ...
            <div class="col-lg-4 form-group">
                <div class="row" >
                    <div class="col-xl-4 col-md-4" style="text-align: right" >
                        <label class="control-label" style="font-weight: normal">所属商家:</label>
                    </div>
                    <div class="col-xl-8 col-md-8">
                        <select name="mch_id" style="padding:4px 8px;color:rgb(106, 105, 105);font-size:12px;" class="form-control" >
