            ...
            <div class="col-lg-8 form-group">
                <div class="row">
                    <div class="col-xl-2 col-md-3" style="text-align: right">
                        <label class="control-label" style="font-weight: normal">生产时间:</label>
                    </div>
                    <div class="col-xl-9 col-md-9" style="padding-left: 0">
                        @component('component/rangedatapicker',['name'=>'produce_time'])
                        @endcomponent
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 form-group">
                <div class="row" >
                    ...
                    <div class="col-xl-8 col-md-8">
                        <select name="produce_queue_status" style="padding:4px 8px;color:rgb(106, 105, 105);font-size:12px;" class="form-control">
