...
@section("main-content")
    ...
    <!--  查询 start -->
        <div class="" style="margin-top:20px">
            @include('backend.queue.deliveryqueue._search')
        </div>
        <!--  查询 end -->
        ...
        <div class="order_statistics_data">
            <div class="order_statistics_data_child">
                <p class="osdc_title">待处理</p>
                <p class="osdc_content">
                    <span class="osdc_content_num osdc_content_blue">{{$queueStatus['ready']}}</span>
                </p>
            </div>
            <div class="order_statistics_data_child">
        ...
        <!-- 列表start  -->
        <div id="table">
            <table class="no-border-table" data-url="/queue/deliveryqueue/list">
                <thead>
                <tr class="table-head">
                    <td>系统订单号</td>
                    <td>运单号</td>
