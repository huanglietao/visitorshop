        ...
        <div class="search-item row" style="" >
            <div class="col-lg-5 form-group">
                <div class="row" >
                    ...
                    <div class="col-xl-8 col-md-8">
                        <select name="material_cate_flag" style="padding:4px 8px;color:rgb(106, 105, 105);font-size:12px;" class="form-control" id="mater_flag">
            ...
            <div class="col-lg-5 form-group">
                <div class="row" >
                    ...
                    <div class="col-xl-8 col-md-8" >
                        <select name="material_cateid" style="padding:4px 8px;color:rgb(106, 105, 105);font-size:12px;" class="form-control mater-catelist">
