...
<div style="margin-top:30px">
    <form class="form-horizontal common-form" id="form-save" method="post" action="/template/material/save" onsubmit="return false;" autocomplete="off">
    <input type=hidden value="{{$row['material_id']}}" name="id" id="id">
        ...
        <div class="form-group row form-item">
            ...
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    ...
                    @endif
                    <span class="col-sm-5 color-6A6969"> 请先选择所属素材分类的一级分类</span>
        ...
        <div class="form-group row form-item">
            ...
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    <input  id="material_name" class="form-control col-sm-6" name="material_name" type="text" value="{{$row['material_name']}}" placeholder="" >
        ...
        <div class="form-group row form-item">
            ...
            <div class="col-xs-12 col-sm-10">
                <div class="row">
                    <input  id="material_sort" class="form-control col-sm-6" name="material_sort" type="text" value="{{$row['material_sort']}}" placeholder="" data-rule="排序:integer(+0);length(~10)">
            ...
            <div class="col-xs-12 col-sm-10">
                <div class="row radio">
                    <div style="display: inline-block;padding-top: 5px;padding-left: 0" class="col-sm-5">
                        @component('component/radio',['radio'=>['1'=>'通用','2'=>'内部'],'name'=>'material_use_type','default_key'=>$row['material_use_type']??1])
                        @endcomponent
                    </div>
                ...
                <div class="col-xs-12 col-sm-10">
                    <div class="row">
                        ...
                        @else
                            ...
                            <div style="padding-left: 0;display: none" class="col-sm-3" id="upload-special">
                                @component('component/imgUpload',['plid'=>"specialImg",'parms'=>'{"type":"special","uniqid":"'.$uniqid.'","m_type":0}','plurl'=>$apiurl.'/material/upload','name'=>'attachment_id','uploader'=>'specialUpoad','direction'=>1,'browse_btn'=>'btn-special','content_class'=>'special','img_format'=>'gif,jpg,jpeg,png','num'=>100,'value'=>''])
                                @endcomponent
                            </div>
                        @endif
