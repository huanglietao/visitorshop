    ...
    <tr>
		...
		<td>
			<p>
				...
				@endif
				<span id="btn_area" class="oa_operate op_tbl btn-dialog btn-edit" data-area="['70%', '70%']" data-url="{{URL::asset('/suppliers/suppliers/form')}}?id={{$v['sup_id']}}" data-title = "编辑">编辑</span>
				<span class="oa_operate op_tbl btn-dialog" data-area="['70%', '70%']" data-url="{{URL::asset('/suppliers/suppliers/logistics_costs')}}?id={{$v['sup_id']}}" data-title = "物流成本">物流成本</span>
