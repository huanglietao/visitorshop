...
@section("main-content")
    ...
    <div id="main">
        ...
        <div class="" style="margin-top:20px; display:none">
            @include('backend.auth.rule._search')
        </div>
        <!--  提示功能 end -->
        ...
        <div id="act-btn" style="padding:20px 0">
            ...
            <button data-area="['60%', '70%']" data-url="{{URL::asset('/auth/rule/form')}}" data-title = "添加" class="btn-dialog btn btn-primary btn-sm btn-3F51B5 btn-add">
