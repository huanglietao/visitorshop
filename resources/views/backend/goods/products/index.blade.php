...
@section("main-content")
    ...
    <div id="main">
        ...
        <div class="" style="margin-top:20px">
            @include('backend.goods.products._search')
        </div>
        <!--  提示功能 end -->
        ...
        <!-- 列表start  -->
        <div id="table">
            <table class="no-border-table" data-url="/goods/products/list">
                <thead>
...
@section("js-file")
    ...
    <script src="{{ URL::asset('js/backend/goods/products.js')}}"></script>
@endsection
