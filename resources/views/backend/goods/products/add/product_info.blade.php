<div class="good-info-fill" style="display: none">
    ...
    <div class="form-group row form-item">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                <input  id="prod_name" class="form-control col-sm-5" name="prod_name" type="text" value="" placeholder="" {{--data-rule="商品名称:required"--}}>
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                ...
                @foreach($chanelList as $k=>$v)
                    ...
                    <div class="col-sm-5" style="line-height: 30px">
                        @component('component/checkbox',['checkbox'=>[$v['cha_id']=>$v['cha_name']],'name'=>['sales_chanel[]'],'data_value'=>$v['cha_flag'] ,'checked'=> $v['cha_id'],'custom_class'=>'','right_distance' => '30'])
                        @endcomponent
                       --}}{{-- <div class="gpd-group">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="row">
                ...
                @foreach($supplierList as $k=>$v)
                    ...
                    <div class="col-sm-5 " style="line-height: 30px">
                        @component('component/checkbox',['checkbox'=>[$v['sup_id']=>$v['supplier_new_name']],'checked'=> $v['sup_id'],'name'=>['supplier[]'],'custom_class'=>'','right_distance' => '30'])
                        @endcomponent
                        {{-- <div class="gpd-group">
                             @component('component/checkbox',['checkbox'=>['银牌组','铜牌组','金牌组'],'name'=>['1','2','3'],'custom_class'=>'','right_distance' => '30'])
                             @endcomponent
                    ...
                    <span class="col-sm-7 color-6A6969">@if($i == 1){{--不勾选下列供应商，则该商品订单将分配给默认供货商平台（商家自有供货）；配置则自动分配给勾选择供应商。--}}@endif</span>
                    @php $i++; @endphp
