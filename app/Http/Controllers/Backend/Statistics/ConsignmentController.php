...
{
    protected $viewPath = 'backend.statistics.consignment';  //当前控制器所的view所在的目录
    protected $modules = 'sys';        //当前控制器所属模块
    protected $merchantID = '';

    public function __construct(SaasOrderFileRepository $orderFileRepository,OmsMerchantInfoRepository $omsMerchantInfoRepository)
    {
        parent::__construct();
    ...
    public function export(Request $request)
    {
        ...
        $Info =  $this->orderFileRepository->getExportTableList($params,'order_file_id desc',ONE)->toArray();
