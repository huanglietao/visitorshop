...
{
    protected $viewPath = 'backend.statistics.goods';  //当前控制器所的view所在的目录
    ...
    public function __construct(SaasOrderProductsRepository $orderProductsRepository,SaasProductsRepository $productsRepository,
                                ...
                                SaasProductsRelationAttrRepository $productsRelAttrRepository,OmsMerchantInfoRepository $omsMerchantInfoRepository)
    {
        parent::__construct();
        ...
        $this->totalNum = $orderProductsRepository->getOrderProducts();
    ...
    {
        return view($this->viewPath.'.index',['totalNum'=>$this->totalNum,'InfoList'=>$this->merchantInfo]);
    }
