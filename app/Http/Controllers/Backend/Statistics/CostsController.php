...
{
    protected $viewPath = 'backend.statistics.costs';  //当前控制器所的view所在的目录
    protected $modules = 'sys';        //当前控制器所属模块
    protected $merchantID = '';

    public function __construct(SaasSalesChanelRepository $chanelRepository,OmsMerchantInfoRepository $omsMerchantInfoRepository,
                                SaasOrderFileDetailRepository $orderFileDetailRepository,SaasOrderFileRepository $orderFileRepository)
    {
        parent::__construct();
    ...
    public function table(Request $request)
    {
        try{
            $params = $request->all();
            $Info =  $this->orderFileDetailRepository->getTableList($params,'file_detail_id desc',ONE)->toArray();
            $costsInfo = $Info['data'];
...
//                }
    ...
    public function export(Request $request)
    {
        ...
        $orderInfo =  $this->orderFileDetailRepository->getExportTableList($params,'file_detail_id desc',ONE)->toArray();
