 ...
 * @date: 2020/7/3
 */
class ErpPushQueueController extends BaseController
{
    protected $viewPath = 'backend.queue.erppushqueue';  //当前控制器所的view所在的目录
    protected $modules = 'sys';        //当前控制器所属模块
    public function __construct(SaasOrderErpPushQueueRepository $Repository)
    {
        parent::__construct();
    ...
    public function index()
    {
        ...
        return view('backend.queue.erppushqueue.index',['queueStatus'=>$this->queueStatus,'queueStatusList'=>$queueStatusList]);
    }
