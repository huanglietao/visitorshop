...
{
    protected $viewPath = 'merchant.statistics.orders';  //当前控制器所的view所在的目录
    protected $modules = 'sys';        //当前控制器所属模块
    protected $merchantID = '';

    public function __construct(SaasOrdersRepository $orderRepository,SaasSalesChanelRepository $chanelRepository,
