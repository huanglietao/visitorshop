...
use App\Http\Requests\Merchant\Agent\GradeRequest;
use App\Repositories\SaasCustomerLevelRepository;
use Illuminate\Http\Request;

/**
 * 项目说明 OMS系统 分销管理--商家组别
 * 详细说明 OMS系统 分销管理--商家组别，实现列表，添加，编辑，删除及组件结合
...
{
    protected $viewPath = 'merchant.agent.grade';  //当前控制器所的view所在的目录
    ...
    public function table(Request $request)
    {
        ...
        $inputs = $request->all();
        $inputs['cust_lv_type']=CHANEL_TERMINAL_AGENT;
...
//        var_dump($params);exit;
        $data = [
            ...
            'cust_lv_type'=>CHANEL_TERMINAL_AGENT,
