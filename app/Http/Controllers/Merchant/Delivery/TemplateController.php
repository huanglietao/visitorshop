<?php
namespace App\Http\Controllers\Merchant\Delivery;
...
/**
 * 项目说明  OMS系统 物流设置-物流模板
 * 详细说明  OMS系统 物流设置-物流模板，实现物流模板列表，添加，编辑，删除及组件结合
...
{
    protected $viewPath = 'merchant.delivery.template';  //当前控制器所的view所在的目录
