...
class PrintsController extends BaseController
{
    ...
    public function index()
    {
        ...
        //获取接口返回的数据
        return view('erp.printscom.index',['type' =>$type,'username' => $username,'company' => $company]);
    }
    ...
    public function check()
    {
        ...
        //通过接口获取订单数据
        $apiOrderData = $this->repositories->getOrdersInfoByApi($key);
    ...
    public function delivery(ErpPrintLogRepository $printLogRepository)
    {
        ...
        $deliveryInfo = $this->repositories->deliveryByApi($printLogInfo);
